...
SystemName = 'LoonanBot'
SystemAvatar = 'https://i.imgur.com/S8FRdUc.png'
local lastBone = nil
  ...
  while true do
      ...
      if FoundLastDamagedBone and LastDamagedBone ~= lastBone then
          ...
          if DamagedBone then
              ...
              -- TriggerEvent('chatMessage', "MedSystem", {255, 0, 0}, message)
              TriggerServerEvent('DiscordBot:ToDiscord', 'kill', SystemName, message, SystemAvatar, true)
              Citizen.Wait(0)
